...
void CheckinWindow::Checkin()
{
        ...
        {
            QSqlQuery my_query;
            my_query.prepare("INSERT INTO users(login, name, surname, age, height, weight, sex, password, lifestyle"
                             "VALUES (:login, :name, :surname, :age, :height, :weight, :sex, :password, :lifestyle);");
            my_query.bindValue(":login", login);
            my_query.bindValue(":name", name);
            my_query.bindValue(":surname", surname);
            my_query.bindValue(":age", age);
            my_query.bindValue(":height", height);
            my_query.bindValue(":weight", weight);
            my_query.bindValue(":sex", sex);
            my_query.bindValue(":password", password);
            my_query.bindValue(":lifestyle", lifestyle);
            this->close();
